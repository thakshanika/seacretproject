    ...
    try {
        ...
        if (!data?.status || !data?.weather) {
            return await sock.sendMessage(from, {
                text: '❌ Weather information එක ලබාගන්න බැරි වුණා.'
            });
        }
...
⚡ *Powered by Shaggy XMD*
        ...
        console.error('WEATHER CASE ERROR:', error);
    ...
    try {
        await sock.sendMessage(from, {
            text: '📰 *Siyatha News* ගන්නවා...'
        });

        const apiUrl =
            'https://api-siteh-22e22e4cb068.herokuapp.com/news/siyatha?api_key=lakiya_2f3b6c382d1236ad7a08d56331fb679935d51dfc846df2c254093fd1fff9494e';
        ...
        if (!data?.status || !data?.result) {
            return await sock.sendMessage(from, {
                text: '❌ News එක ලබාගන්න බැරි වුණා.'
            });
        }
...
⚡ *Powered by Shaggy XMD*
        ...
        console.error('NEWS CASE ERROR:', error);
